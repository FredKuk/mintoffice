...
public class ShowNsearchController implements Controller {
	private NoticeService service;

	public ShowNsearchController() {
		System.out.println("ShowNsearchController");
	}

	public ShowNsearchController(NoticeService service) {
		this.service = service;
		System.out.println("service into Created ShowNsearchController");
	}
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			// 게시물 총목록수
			int totalCount = service.searchCount(search);
			...
			List<Notice> list = service.searchFindAll(intPage,search);
