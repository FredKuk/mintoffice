...
<div class="progress" style="width:20%">
  <div class="progress-bar" role="progressbar" style="width: 70%;background-color:#6CDAB2" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">Personal</div>
  <div class="progress-bar" role="progressbar" style="width: 70%;background-color:#F08080" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100">N.Holiday</div>
</div>
<br>
<div id='calendar'></div>
